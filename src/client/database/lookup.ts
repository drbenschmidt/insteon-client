export type DeviceLookupRecord = {
  category: number;
  subcategory: number;
  sku: number | string;
  name: string;
...
// From https://github.com/kuestess/homebridge-platform-insteonlocal/blob/master/deviceDatabase.json
const deviceLookup: DeviceLookupRecord[] = [
  {
    category: 0,
    subcategory: 4,
    sku: 2430,
...
// From https://github.com/automategreen/home-controller/blob/master/lib/Insteon/utils.js#L3
export const deviceCategoryNames = [
...
export const isLight = (category: number): boolean => [1, 2].includes(category);

export const isDimmable = (category: number): boolean => category === 1;

export const isFan = (category: number, subcategory: number): boolean =>
  category === 1 && subcategory === 46;
